...
const Hotel = ({ hotel }) => {
    ...
    return (
        <div
            ...
            className="w-[252px] lg:w-[279px] bg-white border border-[#DDE7EB] shadow-lg rounded-xl min-h-[442px] flex-shrink-0 mb-6 cursor-pointer transform-gpu transition-all duration-300 hover:scale-105 origin-left relative z-20"
        >
            ...
            <div className="relative">
                <Image
                    ...
                    height={205}
                    alt="Hotel"
                    className="w-full h-[205px] object-cover rounded-t-xl"
                />
